partial class MotoTroop (TroopClass ): 
	...
	override def Awake ():
		...
		WeaponList = [WeaponSystem(Name: "Infantry close range", Range: 1, HardDamage: 3, HardMinimumDamage: 1, SoftDamage: 3, SoftMinimumDamage: 1 )
						, WeaponSystem(Name: "Infantry and IFV missiles", Range: 3, HardDamage: 5, HardMinimumDamage: 2, SoftDamage: 0, SoftMinimumDamage: 0 )
						, WeaponSystem(Name: "Company Mortar Unit", Range: 3, HardDamage: 1, HardMinimumDamage: 0, SoftDamage: 2, SoftMinimumDamage: 1 )
						, WeaponSystem(Name: "Heavy Machineguns", Range: 1, HardDamage: 1, HardMinimumDamage: 0, SoftDamage: 4, SoftMinimumDamage: 2 )
						]
		super()
